    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center h-full w-full">
          <div className="relative h-full w-full  rounded-lg flex items-center justify-center text-white font-bold text-4xl">
          <Image 
            src={project.image} 
            alt={project.title}
            fill
            className="w-full h-auto aspect-square object-contain transition-transform group-hover:scale-105 border-2"
          />
          </div>
        </div>
      </div>
